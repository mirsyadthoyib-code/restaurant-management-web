                                                    ...
                                                    <div class="iq-media-group text-sm-right">
                                                        <a href="#" class="iq-media">
                                                            <img class="img-fluid avatar-40 rounded-circle"
                                                                src="<?= url('images/user/05.jpg') ?>" alt="">
                                                        </a>
                                                        <a href="#" class="iq-media">
                                                            <img class="img-fluid avatar-40 rounded-circle"
                                                                src="<?= url('images/user/06.jpg') ?>" alt="">
                                                        </a>
                                                        <a href="#" class="iq-media">
                                                            <img class="img-fluid avatar-40 rounded-circle"
                                                                src="<?= url('images/user/07.jpg') ?>" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between row">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="iq-media-group text-sm-right">
                                                        <a href="#" class="iq-media">
                                                            <img class="img-fluid avatar-40 rounded-circle"
                                                                src="<?= url('images/user/08.jpg') ?>" alt="">
                                                        </a>
                                                        <a href="#" class="iq-media">
                                                            <img class="img-fluid avatar-40 rounded-circle"
                                                                src="<?= url('images/user/09.jpg') ?>" alt="">
                                                        </a>
                                                        <a href="#" class="iq-media">
                                                            <img class="img-fluid avatar-40 rounded-circle"
                                                                src="<?= url('images/user/04.jpg') ?>" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between row">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="iq-media-group text-sm-right">
                                                        <a href="#" class="iq-media">
                                                            <img class="img-fluid avatar-40 rounded-circle"
                                                                src="<?= url('images/user/01.jpg') ?>" alt="">
                                                        </a>
                                                        <a href="#" class="iq-media">
                                                            <img class="img-fluid avatar-40 rounded-circle"
                                                                src="<?= url('images/user/02.jpg') ?>" alt="">
                                                        </a>
                                                        <a href="#" class="iq-media">
                                                            <img class="img-fluid avatar-40 rounded-circle"
                                                                src="<?= url('images/user/03.jpg') ?>" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
