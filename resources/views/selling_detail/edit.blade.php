                    ...
                    <div class="card">
                        ...
                        <div class="container-fluid row">
                            <div class="card-body col-sm-12">
                                <form class="" action="/selling/detail/update/{{ $id }}" method="post"
                                                ...
                                                id="item">
                                                    @foreach ($menu as $item)
                                                        <option value="{{ $item->id_menu }}"
                                                            @if ($item->id_menu == $jual_menu->id_menu) selected @endif>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="qty" name="qty"
                                                    placeholder="Contoh: 20" value="{{ $jual_menu->kuantitas }}">
                                                @error('qty')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="leftover" name="leftover"
                                                    placeholder="Contoh: 2" value="{{ $jual_menu->sisa }}">
                                                @error('leftover')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
